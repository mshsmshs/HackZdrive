...
return [
    //branding
    ['name' => 'branding.site_name', 'value' => 'hackzDRIVE'],
    ...
    ['name' => 'homepage.appearance', 'value' => json_encode([
        'headerTitle' => 'hackzDRIVE. A new home for your files.',
        ...
        'footerTitle' => 'Get started with hackzDRIVE',
        'footerSubtitle' => null,
        ...
        'primaryFeatures' => [
            ...
            [
                ...
                'subtitle' => 'Your files in hackzDRIVE can be reached from any smartphone, tablet, or computer.',
        ...
        'secondaryFeatures' => [
            [
                ...
                'description' => 'If something happens to your device, you don\'t have to worry about losing your files or photos – they\'re in your hackzDRIVE. And hackzDRIVE is encrypted using SSL.'
            ],
            [
                'title' => 'Reliable storage and fast transfers',
                'image' => 'client/assets/images/homepage/homepage-feature-2.jpg',
                'description' => 'We make secure cloud storage simple and convenient. Create a free hackzDRIVE account today!'
            ]
        ],
    ])],
